...
if __name__ == '__main__':
    ...
    for link in data.split("\n"):
        ...
        #     print(base+attr[1].split("=")[1].strip('"'))
            get_data_2020.main(base+attr[1].split("=")[1].strip('"'),"2020",attr[-2])
        elif(attr[-1]=="2021"):
        #     print(base+attr[1].split("=")[1].strip('"'))
            get_data_2020.main(base+attr[1].split("=")[1].strip('"'),"2021",attr[-2])
        elif(attr[-1]=="2022"):
        #     print(base+attr[1].split("=")[1].strip('"'))
            get_data_2020.main(base+attr[1].split("=")[1].strip('"'),"2022",attr[-2])
    fp1.close()
